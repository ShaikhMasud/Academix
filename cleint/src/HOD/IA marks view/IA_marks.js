...
const IAview = () => {
    useEffect(() => {
        ...
        if (examSelect) {
            ...
            handleExamSelect({ target: { value: examSelect.value } })
    ...
    const handleSubmit = async () => {
        ...
        if (examSelect.value === "IA1") {
            examType = "IA1";
        } else if (examSelect.value === "IA2") {
            examType = "IA2";
        } else if (examSelect.value === "ESE") {
            examType = "ESE";
        } else {
            examType = "Assignment";
        }
        ...
        user.role === "HOD" ? (
            <div>
                ...
                <div className="container">
                    ...
                    <select id="examSelect" onChange={handleExamSelect} defaultValue={ia}>
